...
class TriangleSurface
{
    ...
    {
        double area = (double)(sideOne * sideTwo * Math.Sin(angle*Math.PI/180)) / 2;
        return area;
    }
    public static void Main()
    {
        ...
        Console.WriteLine("The area is:{0:F1}", CalcAreaBySideAndAltitude(a, h));
        Console.WriteLine("The area is:{0:F1}", CalcAreaByThreeSides(a, b, c));
        Console.WriteLine("The area is:{0:F1}", CalcAreaByTwoSidesAndAngle(a, b, angle));
        Console.WriteLine();
        //not full!
    }
}
